...
<table>
  ...
  <tr>
    <td width="50%">
      ...
      <p>Ищет по истории и reply-веткам, понимает участников и фото в reply, при необходимости подключает web и GitHub и отвечает в Rich Markdown.</p>
    </td>
    <td width="50%">
...
| `/ask <вопрос>` | Универсальный Rich Markdown-помощник с read-only поиском по чату, web и GitHub. В reply учитывает исходное сообщение и его фото. Доступен всем участникам основного чата; в личке — только private allowlist. |
