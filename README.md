...
- [x] `/report` с дедупликацией сообщений, личной доставкой администраторам и rich-карточками;
...
| `/report [причина]` | Reply на сообщение человека: один репорт на сообщение навсегда, от одного репортёра — не чаще одного репорта за 10 минут. Карточка уходит администраторам в личку. |
