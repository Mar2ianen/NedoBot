...
| `/drafter_smoke` | Временный dev-only smoke test native rich Drafter в личке: thinking/rich blocks, coalescing, flush, refresh, segment rotation, accumulator и abort. |
