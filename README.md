...
| `/userstats <id\|username>` | Карточка пользователя: статус, первые/последние сообщения, активные дни, реплаи, ссылки, медиа и реакции. Работает по числовому ID, уже виденному ботом username или reply на сообщение пользователя. |
