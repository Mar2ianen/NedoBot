...
| `/ask <вопрос>` | Универсальный Rich Markdown-помощник с read-only поиском по чату, web и GitHub. В reply учитывает исходное сообщение и его фото. На этапе rollout доступен владельцу, администраторам и private allowlist. |
