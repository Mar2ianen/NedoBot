...
те же фильтры и является authoritative-путём для количества matching-сообщений, а не для количества событий или вхождений слова внутри сообщения. Режимы поиска:
