...
Текущий deploy на `vps-153` использует teloxide fork `0.20.0` / `teloxide-core 0.16.0` и typed Telegram API methods. Immutable tag [`deploy-2026-08-24-teloxide-0.20.0`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-08-24-teloxide-0.20.0) фиксирует commit `1a8b658` с фактически собранным и проверенным release binary, использующим fork merge `26d80f5f`. Предыдущая линия fork `0.18` зафиксирована тегом [`deploy-2026-07-31-teloxide-fork`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-teloxide-fork); release `v0.12.0` — [`deploy-2026-07-31-v0.12.0`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-v0.12.0), voice flow — [`deploy-2026-07-31-voice-flow`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-voice-flow), unified audit — [`deploy-2026-07-30-unified-audit`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-30-unified-audit). Последующие commits разрабатываются в `dev` и не считаются deployed до отдельного merge/review.
