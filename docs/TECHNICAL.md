...
Текущий deploy на `vps-153` использует teloxide fork `0.20.0` / `teloxide-core 0.16.0` и typed Telegram API methods. Immutable tag [`deploy-2026-08-28-report`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-08-28-report) фиксирует commit `4cdf29e` с фактически собранным и проверенным release binary, включающим private `/report`, rich-карточки админам и durable delivery worker. Предыдущая линия fork `0.20.0` зафиксирована тегом [`deploy-2026-08-24-teloxide-0.20.0`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-08-24-teloxide-0.20.0); fork `0.18` — [`deploy-2026-07-31-teloxide-fork`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-teloxide-fork); release `v0.12.0` — [`deploy-2026-07-31-v0.12.0`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-v0.12.0), voice flow — [`deploy-2026-07-31-voice-flow`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-31-voice-flow), unified audit — [`deploy-2026-07-30-unified-audit`](https://github.com/Mar2ianen/NedoBot/tree/deploy-2026-07-30-unified-audit). Последующие commits разрабатываются в `dev` и не считаются deployed до отдельного merge/review.
...
- В карточке используются typed Rich Message blocks и Bot API 10.3 buttons: ссылка на исходное сообщение, профиль, `Спам` и `Не спам`. Callback повторно проверяет актуальное админство; решение атомарно фиксируется в `telegram_reports` и после этого кнопки заменяются на disabled-состояние. Кнопки не банят и не удаляют сообщения автоматически.
