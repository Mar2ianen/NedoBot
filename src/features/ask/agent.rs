...
fn cited_message_ids(markdown: &str) -> Vec<i32> {
    ...
    while let Some(start) = remainder.find("message_") {
        remainder = &remainder[start + "message_".len()..];
